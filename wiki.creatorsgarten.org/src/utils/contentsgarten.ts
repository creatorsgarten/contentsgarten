import { createContentsgarten } from 'contentsgarten'
...
/**
 * When BACKEND=production, forward the request to the live site instead of
 * running against local credentials. Used for both the tRPC and REST API
 * routes.
 */
export async function proxyToProduction(request: Request) {
